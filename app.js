...
function handleSubmit(e) {
  ...
  document.getElementById("phone_resume").innerHTML=phone.value;
  document.getElementById("github_resume").innerHTML=github.value;
  document.getElementById("linkedin_resume").innerHTML=linkedin.value;
